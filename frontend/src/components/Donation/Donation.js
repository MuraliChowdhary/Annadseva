      ...
      <div className="donation-requests">
        {requests.map(request => (
          <div key={request.id} className="donation-request">
            ...
            <p>Amount needed: {request.amount} (feeds approx {request.people} people)</p>
            <button className="donate-button green-button" onClick={() => openForm(request.id)}>Donate</button>
          </div>
        ))}
        <div className="donation-request">
            ...
            <button className="donate-button green-button" onClick={() => openForm(11)}>Donate</button>
          </div>
      </div>
      {showForm && (
